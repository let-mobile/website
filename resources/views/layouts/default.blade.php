        ...
        <div class="topNavSocial p-2">
            <div class="container">
                <ul class="float-left p-0 m-0 d-none d-sm-inline d-xs-inline">
                    <li class="mr-3"><a href="https://www.facebook.com/letmobilepkofficial" target="_blank"><img src="{{ asset('public/assets/images/facebook.png') }}" alt="Let Mobile Facebook Page"></a></li>
                    <li class="mr-3"><a href="https://www.pinterest.com/letmobilepk/" target="_blank"><img src="{{ asset('public/assets/images/pintrest.png') }}" alt="Let Mobile Pintrest Profile"></a></li>
                    <li class="mr-3"><a href="https://twitter.com/LetMobile1" target="_blank"><img src="{{ asset('public/assets/images/twitter.png') }}" alt="Let Mobile Twitter Profile"></a></li>
                    <li class="mr-3"><a href="https://www.instagram.com/letmobilepk/" target="_blank"><img src="{{ asset('public/assets/images/insta.png') }}" alt="Let Mobile Instagram Account"></a></li>
                </ul>     
                ...
                <ul class=" d-inline">
                    ...
                    <li><a href="{{ url('login') }}" class="text-white fs-6 text-decoration-none">Register</a></li>
                </ul>
                </ul>
            </div>
        </div>
