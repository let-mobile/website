...
@section('title')
<title> 
{{ (request()->segment(4) == 'published') ? 'My Ads' : '' }} 
{{ (request()->segment(4) == 'unverified') ? 'Unverified Ads' : '' }}
{{ (request()->segment(4) == 'deleted') ? 'Deleted Ads' : '' }} 
{{ (request()->segment(4) == 'solded') ? 'Solded Ads' : '' }}
                                        ...
                                        <tr data-category="active">
                                            <td class="photo">
                                                <a href="{{ url($ad['adslug'])}}">
                                                    <img class="img-fluid" src="{{ url('public/images').'/'.$images[0] }}" alt="{{ @ucwords($row['adtitle']) }}">
                                                </a>
                                            </td>
                                            <td data-title="Title">
