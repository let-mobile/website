    ...
    <div class="col-md-12 h-100 p-0">
        <div class="">
            <form action="" class="p-3">
                <input type="text" class="mb-3 form-control" placeholder="Looking for ..." name="q" value="{{ request()->q ?? '' }}">
                ...
                <input type="search" name="q_loc" value="{{ request()->q_loc ?? '' }}" id="q_loc" placeholder="Enter location"  class="mb-3 form-control">
                <div id="search-loc"></div>
                <div id="default-loc">
                    <div class="form-check">
                ...
                <input type="search" name="q_br" value="{{ request()->q_br ?? '' }}" id="q_br" placeholder="Enter Brand" class="mb-3 form-control" >
                <div id="search-brand"></div>
                <div id="default-brand">
                    <div class="form-check">
